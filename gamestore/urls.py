...
from .views import IndexView, RegistrationView, ProfileView, GameView, GameCreateView, TagCreateView, GameUpdateView, payment_view, example_game, switch_to_developer, confirm_email
